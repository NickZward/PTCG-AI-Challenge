...
Usage: scrape_top_fresh.py [--probe]
"""
...
TARGET_NAMES = {n.lower() for n in ["Sixth Sense", "Dipam Chakraborty", "flg", "やる気元気ミワハルキ"]}
EP_FLOOR = 92250000   # newer than our newest known games from these pilots
PER_TEAM_CAP = 350           # newest first
OUT = Path("/Users/nickzwart/Desktop/PTCG-AI-Challenge/top_fresh")
