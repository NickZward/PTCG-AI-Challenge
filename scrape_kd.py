...
Usage: scrape_kd_fresh.py [--probe]
"""
...
TARGET_NAMES = {n.lower() for n in ["@kdcyberdude"]}
EP_FLOOR = 92060000   # strictly newer than the newest game in the user drop (92058540)
PER_TEAM_CAP = 350           # newest first
OUT = Path("/Users/nickzwart/Desktop/PTCG-AI-Challenge/kd_fresh")
