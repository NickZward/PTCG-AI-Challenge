...
Usage: agree_dudun.py [agent_dir]   (default my-agent/ogerpon_v1)
"""
import glob, importlib.util, json, os, sys
from collections import Counter

ROOT = "/Users/nickzwart/Desktop/PTCG-AI-Challenge"
AGENT_DIR = sys.argv[1] if len(sys.argv) > 1 else "my-agent/ogerpon_v1"
...
for path in sorted(glob.glob('/Users/nickzwart/Desktop/Palsystem/*.json')):
