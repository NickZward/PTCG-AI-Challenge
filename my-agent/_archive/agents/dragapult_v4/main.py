...
def choose_main(obs):
    ...
    if attach and not st.energyAttached:
        ...
        def score(o):
            ...
            # Phantom Dive costs {R}{P} — a second copy of the same basic
            # energy bricks the attacker. Punish duplicate-type attaches.
            if cid in (DRAGAPULT, DRAKLOAK, DREEPY) and src in (2, 5):
