...
def PLAY_PRIORITY(cid, c):
    ...
    if c.get('deck_race'):
        ...
        # v22 (ep87469704: lost a 53-turn Crustle epic BY ONE CARD while leading 5-3,
        # having played small-hand Lillie's 5x): Lillie's with hand<8 is a net deck
        # DRAIN (shuffle hand, draw 8) — in a deck race only the big-hand REFUEL
        # version is allowed.
        if cid == 1227 and len(c['hand']) < 8 and c['deck_count'] <= 18: return 99
