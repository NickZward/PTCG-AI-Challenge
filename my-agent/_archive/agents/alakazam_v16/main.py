"""Alakazam pilot v16 — modern body (oracle, prize inference, guards)
...
v16 = v15 + MIRROR CONVERSION DISCIPLINE (from a 14-agent autopsy of 31 mirror losses
vs 21 elite wins; our mirror WR 34% vs elite 52-70% on the identical deck). The gap is
NOT setup-to-first-Alakazam (matches elite ~T4.3) but CONVERSION/RESILIENCE after:
  (1) ENERGY DISCIPLINE (attach step): only ever energize the Alakazam line; never
      dead-end our 6 scarce psychic on Fez/Dunsparce/Dudunsparce (the #1 leak).
  (2) FEZ PROMOTE-LAST: never volunteer the 2-prize Fezandipiti ex as active (it died
      active in 19% of our mirror losses = 2 prizes each; Yushin 0%).
Follow-ups still open (documented, not yet implemented): rebuild-a-2nd-Alakazam after the
first dies + attack-every-online-turn; anti-deckout when hoarding while ahead.
"""
